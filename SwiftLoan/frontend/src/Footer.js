...
const Footer = ()=>{
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p class="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4 text-white">© 2024 SwiftLoan —
      <a href="https://twitter.com/knyttneve" class="text-gray-500 ml-1 text-white" target="_blank" rel="noopener noreferrer">@Mahendra Singh</a>
    </p>
