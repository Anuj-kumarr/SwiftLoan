...
const NavbarAdmin = ()=>{
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
      <a class="mr-5 hover:text-white  cursor-pointer" onClick= {LoanRequest}>Loan Request</a>
      <a class="mr-5 hover:text-white  cursor-pointer" onClick= {AddAdmin}>Add Admin</a>
